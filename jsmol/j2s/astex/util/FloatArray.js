...
this.objects =  Clazz.newFloatArray (initialSize, 0);
}this.objectCount = 0;
...
newCapacity = 1;
}var newObjects =  Clazz.newFloatArray (newCapacity, 0);
...
this.objects =  Clazz.newFloatArray (this.objectCount, 0);
}, "~N");
