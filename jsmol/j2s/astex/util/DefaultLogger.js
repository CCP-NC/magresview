...
Clazz.load (["astex.util.LoggerInterface"], "astex.util.DefaultLogger", ["astex.util.Logger"], function () {
c$ = Clazz.declareType (astex.util, "DefaultLogger", null, astex.util.LoggerInterface);
Clazz.defineMethod (c$, "log", 
function (out, level, txt, e) {
if (out === System.err) System.out.flush ();
if ((out != null) && ((txt != null) || (e != null))) {
txt = (txt != null ? txt : "");
out.println ((astex.util.Logger.logLevel () ? "[" + astex.util.Logger.getLevel (level) + "] " : "") + txt + (e != null ? ": " + e.toString () : ""));
if (e != null) {
