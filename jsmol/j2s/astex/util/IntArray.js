...
this.objects =  Clazz.newIntArray (initialSize, 0);
}this.objectCount = 0;
...
newCapacity = 1;
}var newObjects =  Clazz.newIntArray (newCapacity, 0);
...
this.objects =  Clazz.newIntArray (this.objectCount, 0);
}, "~N");
