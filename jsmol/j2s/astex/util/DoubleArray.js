...
this.objects =  Clazz.newDoubleArray (initialSize, 0);
}this.objectCount = 0;
...
newCapacity = 1;
}var newObjects =  Clazz.newDoubleArray (newCapacity, 0);
...
this.objects =  Clazz.newDoubleArray (this.objectCount, 0);
}, "~N");
...
this.objectCount--;
this.objects[this.objectCount] = 0.0;
