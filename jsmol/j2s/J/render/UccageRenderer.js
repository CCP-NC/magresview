...
if (!this.isExport && this.vwr.getBoolean (603979828) && !this.vwr.isPreviewOnly () && !unitcell.isPeriodic () && this.g3d.setC (this.vwr.getColixBackgroundContrast ())) this.renderInfo (unitcell);
}, "~N");
