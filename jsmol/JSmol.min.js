...
return l}function C(l,a){var b,c,d=0,f=typeof l.getElementsByTagName!==R?l.getElementsByTagName(a||"*"):typeof l.querySelectorAll!==R?l.querySelectorAll(a||"*"):void 0;if(!f){f=[];for(b=l.childNodes||l;null!=(c=b[d]);d++)!a||h.nodeName(c,a)?f.push(c):h.merge(f,C(c,a))}return void 0===a||a&&h.nodeName(l,a)?h.merge([l],f):f}function P(l){kb.test(l.type)&&(l.defaultChecked=l.checked)}function A(l,a){return h.nodeName(l,"table")&&h.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?l.getElementsByTagName("tbody")[0]||
l.appendChild(l.ownerDocument.createElement("tbody")):l}function x(l){l.type=(null!==h.find.attr(l,"type"))+"/"+l.type;return l}function H(l){var a=Xc.exec(l.type);a?l.type=a[1]:l.removeAttribute("type");return l}function I(l,a){for(var b,c=0;null!=(b=l[c]);c++)h._data(b,"globalEval",!a||h._data(a[c],"globalEval"))}function Tb(l,a){if(1===a.nodeType&&h.hasData(l)){var b,c,d;c=h._data(l);var f=h._data(a,c),k=c.events;if(k)for(b in delete f.handle,f.events={},k){c=0;for(d=k[b].length;c<d;c++)h.event.add(a,
...
h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(l,a){Oa["[object "+a+"]"]=a.toLowerCase()});var rb=a,z=function(l,a,b,c){var d,f,k,h,p;(a?a.ownerDocument||a:S)!==K&&ba(a);a=a||K;b=b||[];if(!l||"string"!==typeof l)return b;if(1!==(h=a.nodeType)&&9!==h)return[];if(X&&!c){if(d=fd.exec(l))if(k=d[1])if(9===h)if((f=a.getElementById(k))&&f.parentNode){if(f.id===k)return b.push(f),b}else return b;else{if(a.ownerDocument&&(f=a.ownerDocument.getElementById(k))&&Ea(a,
f)&&f.id===k)return b.push(f),b}else{if(d[2])return ca.apply(b,a.getElementsByTagName(l)),b;if((k=d[3])&&B.getElementsByClassName&&a.getElementsByClassName)return ca.apply(b,a.getElementsByClassName(k)),b}if(B.qsa&&(!O||!O.test(l))){f=d=F;k=a;p=9===h&&l;if(1===h&&"object"!==a.nodeName.toLowerCase()){h=Pa(l);(d=a.getAttribute("id"))?f=d.replace(gd,"\\$&"):a.setAttribute("id",f);f="[id='"+f+"'] ";for(k=h.length;k--;)h[k]=f+Qa(h[k]);k=sb.test(l)&&tb(a.parentNode)||a;p=h.join(",")}if(p)try{return ca.apply(b,
k.querySelectorAll(p)),b}catch(r){}finally{d||a.removeAttribute("id")}}}var e;a:{l=l.replace(Ra,"$1");f=Pa(l);if(!c&&1===f.length){d=f[0]=f[0].slice(0);if(2<d.length&&"ID"===(e=d[0]).type&&B.getById&&9===a.nodeType&&X&&v.relative[d[1].type]){a=(v.find.ID(e.matches[0].replace(da,ea),a)||[])[0];if(!a){e=b;break a}l=l.slice(d.shift().value.length)}for(h=Sa.needsContext.test(l)?0:d.length;h--;){e=d[h];if(v.relative[k=e.type])break;if(k=v.find[k])if(c=k(e.matches[0].replace(da,ea),sb.test(d[0].type)&&
...
if(!b)break}return a?k.length:k?z.error(l):pc(l,h).slice(0)},Qa=function(l){for(var a=0,b=l.length,c="";a<b;a++)c+=l[a].value;return c},xb=function(l,a,b){var c=a.dir,d=b&&"parentNode"===c,f=ld++;return a.first?function(a,b,f){for(;a=a[c];)if(1===a.nodeType||d)return l(a,b,f)}:function(a,b,w){var k,D,h=[V,f];if(w)for(;a=a[c];){if((1===a.nodeType||d)&&l(a,b,w))return!0}else for(;a=a[c];)if(1===a.nodeType||d){D=a[F]||(a[F]={});if((k=D[c])&&k[0]===V&&k[1]===f)return h[2]=k[2];D[c]=h;if(h[2]=l(a,b,w))return!0}}},
yb=function(l){return 1<l.length?function(a,b,c){for(var d=l.length;d--;)if(!l[d](a,b,c))return!1;return!0}:l[0]},Ta=function(l,a,b,c,d){for(var f,k=[],h=0,p=l.length,r=null!=a;h<p;h++)if(f=l[h])if(!b||b(f,c,d))k.push(f),r&&a.push(h);return k},zb=function(l,a,b,c,d,f){c&&!c[F]&&(c=zb(c));d&&!d[F]&&(d=zb(d,f));return T(function(f,k,h,p){var r,e,g=[],j=[],s=k.length,M;if(!(M=f)){M=a||"*";for(var q=h.nodeType?[h]:h,m=[],G=0,C=q.length;G<C;G++)z(M,q[G],m);M=m}M=l&&(f||!a)?Ta(M,g,l,h,p):M;q=b?d||(f?l:
s||c)?[]:k:M;b&&b(M,q,h,p);if(c){r=Ta(q,j);c(r,[],h,p);for(h=r.length;h--;)if(e=r[h])q[j[h]]=!(M[j[h]]=e)}if(f){if(d||l){if(d){r=[];for(h=q.length;h--;)if(e=q[h])r.push(M[h]=e);d(null,q=[],r,p)}for(h=q.length;h--;)if((e=q[h])&&-1<(r=d?oa.call(f,e):g[h]))f[r]=!(k[r]=e)}}else q=Ta(q===k?q.splice(s,q.length):q),d?d(null,k,q,p):ca.apply(k,q)})},Ab=function(l){var a,b,c,d=l.length,f=v.relative[l[0].type];b=f||v.relative[" "];for(var k=f?1:0,h=xb(function(l){return l===a},b,!0),p=xb(function(l){return-1<
oa.call(a,l)},b,!0),r=[function(l,b,c){return!f&&(c||b!==Ua)||((a=b).nodeType?h(l,b,c):p(l,b,c))}];k<d;k++)if(b=v.relative[l[k].type])r=[xb(yb(r),b)];else{b=v.filter[l[k].type].apply(null,l[k].matches);if(b[F]){for(c=++k;c<d&&!v.relative[l[c].type];c++);return zb(1<k&&yb(r),1<k&&Qa(l.slice(0,k-1).concat({value:" "===l[k-2].type?"*":""})).replace(Ra,"$1"),b,k<c&&Ab(l.slice(k,c)),c<d&&Ab(l=l.slice(c)),c<d&&Qa(l))}r.push(b)}return yb(r)},wa,B,v,Va,qc,ub,Ua,fa,xa,ba,K,Z,X,O,pa,Wa,Ea,F="sizzle"+-new Date,
...
function(l,a){for(var b=l.length,c=0;l[b++]=a[c++];);l.length=b-1}}}B=z.support={};qc=z.isXML=function(l){return(l=l&&(l.ownerDocument||l).documentElement)?"HTML"!==l.nodeName:!1};ba=z.setDocument=function(l){var a=l?l.ownerDocument||l:S;l=a.defaultView;if(a===K||9!==a.nodeType||!a.documentElement)return K;K=a;Z=a.documentElement;X=!qc(a);l&&l!==l.top&&(l.addEventListener?l.addEventListener("unload",function(){ba()},!1):l.attachEvent&&l.attachEvent("onunload",function(){ba()}));B.attributes=U(function(a){a.className=
"i";return!a.getAttribute("className")});B.getElementsByTagName=U(function(l){l.appendChild(a.createComment(""));return!l.getElementsByTagName("*").length});B.getElementsByClassName=Fa.test(a.getElementsByClassName)&&U(function(a){a.innerHTML="<div class='a'></div><div class='a i'></div>";a.firstChild.className="i";return 2===a.getElementsByClassName("i").length});B.getById=U(function(l){Z.appendChild(l).id=F;return!a.getElementsByName||!a.getElementsByName(F).length});B.getById?(v.find.ID=function(a,
l){if(typeof l.getElementById!==va&&X){var b=l.getElementById(a);return b&&b.parentNode?[b]:[]}},v.filter.ID=function(a){var l=a.replace(da,ea);return function(a){return a.getAttribute("id")===l}}):(delete v.find.ID,v.filter.ID=function(a){var l=a.replace(da,ea);return function(a){return(a=typeof a.getAttributeNode!==va&&a.getAttributeNode("id"))&&a.value===l}});v.find.TAG=B.getElementsByTagName?function(a,l){if(typeof l.getElementsByTagName!==va)return l.getElementsByTagName(a)}:function(a,l){var b,
c=[],d=0,f=l.getElementsByTagName(a);if("*"===a){for(;b=f[d++];)1===b.nodeType&&c.push(b);return c}return f};v.find.CLASS=B.getElementsByClassName&&function(a,l){if(typeof l.getElementsByClassName!==va&&X)return l.getElementsByClassName(a)};pa=[];O=[];if(B.qsa=Fa.test(a.querySelectorAll))U(function(a){a.innerHTML="<select t=''><option selected=''></option></select>";a.querySelectorAll("[t^='']").length&&O.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||O.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
a.querySelectorAll(":checked").length||O.push(":checked")}),U(function(l){var b=a.createElement("input");b.setAttribute("type","hidden");l.appendChild(b).setAttribute("name","D");l.querySelectorAll("[name=d]").length&&O.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");l.querySelectorAll(":enabled").length||O.push(":enabled",":disabled");l.querySelectorAll("*,:x");O.push(",.*:")});(B.matchesSelector=Fa.test(Wa=Z.webkitMatchesSelector||Z.mozMatchesSelector||Z.oMatchesSelector||Z.msMatchesSelector))&&U(function(a){B.disconnectedMatch=
...
typeof a.getAttribute!==va&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=z.attr(d,a);if(null==d)return"!="===b;if(!b)return!0;d+="";return"="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1}},CHILD:function(a,b,c,d,f){var k="nth"!==a.slice(0,3),h="last"!==a.slice(-4),p="of-type"===b;return 1===d&&0===f?function(a){return!!a.parentNode}:
function(b,c,w){var D,r,e,g,j;c=k!==h?"nextSibling":"previousSibling";var s=b.parentNode,q=p&&b.nodeName.toLowerCase();w=!w&&!p;if(s){if(k){for(;c;){for(r=b;r=r[c];)if(p?r.nodeName.toLowerCase()===q:1===r.nodeType)return!1;j=c="only"===a&&!j&&"nextSibling"}return!0}j=[h?s.firstChild:s.lastChild];if(h&&w){w=s[F]||(s[F]={});D=w[a]||[];g=D[0]===V&&D[1];e=D[0]===V&&D[2];for(r=g&&s.childNodes[g];r=++g&&r&&r[c]||(e=g=0)||j.pop();)if(1===r.nodeType&&++e&&r===b){w[a]=[V,g,e];break}}else if(w&&(D=(b[F]||(b[F]=
{}))[a])&&D[0]===V)e=D[1];else for(;r=++g&&r&&r[c]||(e=g=0)||j.pop();)if((p?r.nodeName.toLowerCase()===q:1===r.nodeType)&&++e)if(w&&((r[F]||(r[F]={}))[a]=[V,e]),r===b)break;e-=f;return e===d||0===e%d&&0<=e/d}}},PSEUDO:function(a,b){var c,d=v.pseudos[a]||v.setFilters[a.toLowerCase()]||z.error("unsupported pseudo: "+a);return d[F]?d(b):1<d.length?(c=[a,a,"",b],v.setFilters.hasOwnProperty(a.toLowerCase())?T(function(a,l){for(var c,f=d(a,b),k=f.length;k--;)c=oa.call(a,f[k]),a[c]=!(l[c]=f[k])}):function(a){return d(a,
0,c)}):d}},pseudos:{not:T(function(a){var b=[],c=[],d=ub(a.replace(Ra,"$1"));return d[F]?T(function(a,l,b,c){c=d(a,null,c,[]);for(var f=a.length;f--;)if(b=c[f])a[f]=!(l[f]=b)}):function(a,l,f){b[0]=a;d(b,null,f,c);return!c.pop()}}),has:T(function(a){return function(b){return 0<z(a,b).length}}),contains:T(function(a){return function(b){return-1<(b.textContent||b.innerText||Va(b)).indexOf(a)}}),lang:T(function(a){rd.test(a||"")||z.error("unsupported lang: "+a);a=a.replace(da,ea).toLowerCase();return function(b){var c;
...
return a})}};v.pseudos.nth=v.pseudos.eq;for(wa in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})v.pseudos[wa]=hd(wa);for(wa in{submit:!0,reset:!0})v.pseudos[wa]=id(wa);oc.prototype=v.filters=v.pseudos;v.setFilters=new oc;ub=z.compile=function(a,b){var c,d=[],f=[],k=sc[a+" "];if(!k){b||(b=Pa(a));for(c=b.length;c--;)k=Ab(b[c]),k[F]?d.push(k):f.push(k);var h=0<d.length,p=0<f.length;c=function(a,b,l,c,k){var w,D,r,e=0,g="0",j=a&&[],s=[],q=Ua,M=a||p&&v.find.TAG("*",k),m=V+=null==q?1:Math.random()||
0.1,G=M.length;for(k&&(Ua=b!==K&&b);g!==G&&null!=(w=M[g]);g++){if(p&&w){for(D=0;r=f[D++];)if(r(w,b,l)){c.push(w);break}k&&(V=m)}h&&((w=!r&&w)&&e--,a&&j.push(w))}e+=g;if(h&&g!==e){for(D=0;r=d[D++];)r(j,s,b,l);if(a){if(0<e)for(;g--;)!j[g]&&!s[g]&&(s[g]=nd.call(c));s=Ta(s)}ca.apply(c,s);k&&(!a&&0<s.length&&1<e+d.length)&&z.uniqueSort(c)}k&&(V=m,Ua=q);return j};c=h?T(c):c;k=sc(a,c)}return k};B.sortStable=F.split("").sort(Bb).join("")===F;B.detectDuplicates=!!xa;ba();B.sortDetached=U(function(a){return a.compareDocumentPosition(K.createElement("div"))&
1});U(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||wb("type|href|height|width",function(a,b,c){if(!c)return a.getAttribute(b,"type"===b.toLowerCase()?1:2)});(!B.attributes||!U(function(a){a.innerHTML="<input/>";a.firstChild.setAttribute("value","");return""===a.firstChild.getAttribute("value")}))&&wb("value",function(a,b,c){if(!c&&"input"===a.nodeName.toLowerCase())return a.defaultValue});U(function(a){return null==a.getAttribute("disabled")})||wb("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
function(a,b,c){var d;if(!c)return!0===a[b]?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null});h.find=z;h.expr=z.selectors;h.expr[":"]=h.expr.pseudos;h.unique=z.uniqueSort;h.text=z.getText;h.isXMLDoc=z.isXML;h.contains=z.contains;var wc=h.expr.match.needsContext,xc=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Uc=/^.[^:#\[\.,]*$/;h.filter=function(a,b,c){var d=b[0];c&&(a=":not("+a+")");return 1===b.length&&1===d.nodeType?h.find.matchesSelector(d,a)?[d]:[]:h.find.matches(a,h.grep(b,function(a){return 1===
...
b,c,d,f){var k,p,r,e,g,s,j,q,m,G,C,P=h.hasData(a)&&h._data(a);if(P&&(s=P.events)){b=(b||"").match(Y)||[""];for(g=b.length;g--;)if(r=Cc.exec(b[g])||[],m=C=r[1],G=(r[2]||"").split(".").sort(),m){j=h.event.special[m]||{};m=(d?j.delegateType:j.bindType)||m;q=s[m]||[];r=r[2]&&RegExp("(^|\\.)"+G.join("\\.(?:.*\\.|)")+"(\\.|$)");for(e=k=q.length;k--;)if(p=q[k],(f||C===p.origType)&&(!c||c.guid===p.guid)&&(!r||r.test(p.namespace))&&(!d||d===p.selector||"**"===d&&p.selector))q.splice(k,1),p.selector&&q.delegateCount--,
...
a.nodeName+">")?k=a.cloneNode(!0):(Gb.innerHTML=a.outerHTML,Gb.removeChild(k=Gb.firstChild));if((!t.noCloneEvent||!t.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!h.isXMLDoc(a)){d=C(k);r=C(a);for(p=0;null!=(f=r[p]);++p)if(d[p]){var g=d[p],s=void 0,j=void 0,q=void 0;if(1===g.nodeType){s=g.nodeName.toLowerCase();if(!t.noCloneEvent&&g[h.expando]){q=h._data(g);for(j in q.events)h.removeEvent(g,j,q.handle);g.removeAttribute(h.expando)}if("script"===s&&g.text!==f.text)x(g).text=f.text,H(g);else if("object"===
s)g.parentNode&&(g.outerHTML=f.outerHTML),t.html5Clone&&(f.innerHTML&&!h.trim(g.innerHTML))&&(g.innerHTML=f.innerHTML);else if("input"===s&&kb.test(f.type))g.defaultChecked=g.checked=f.checked,g.value!==f.value&&(g.value=f.value);else if("option"===s)g.defaultSelected=g.selected=f.defaultSelected;else if("input"===s||"textarea"===s)g.defaultValue=f.defaultValue}}}if(b)if(c){r=r||C(a);d=d||C(k);for(p=0;null!=(f=r[p]);p++)Tb(f,d[p])}else Tb(a,k);d=C(k,"script");0<d.length&&I(d,!e&&C(a,"script"));return k},
...
e.eq(c);j&&(a[0]=s.call(this,c,d.html()));d.domManip(a,b)});if(r&&(k=h.buildFragment(a,this[0].ownerDocument,!1,this),c=k.firstChild,1===k.childNodes.length&&(k=c),c)){f=h.map(C(k,"script"),x);for(d=f.length;p<r;p++)c=k,p!==g&&(c=h.clone(c,!0,!0),d&&h.merge(f,C(c,"script"))),b.call(this[p],c,p);if(d){k=f[f.length-1].ownerDocument;h.map(f,H);for(p=0;p<d;p++)if(c=f[p],Hc.test(c.type||"")&&!h._data(c,"globalEval")&&h.contains(k,c))c.src?h._evalUrl&&h._evalUrl(c.src):h.globalEval((c.text||c.textContent||
...
h.ajaxSettings),b):mb(h.ajaxSettings,a)},ajaxPrefilter:gc(Oc),ajaxTransport:gc(lb),ajax:function(a,b){function c(a,b,d,f){var l,s,A,w;w=b;if(2!==x){x=2;r&&clearTimeout(r);g=void 0;p=f||"";y.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(d){A=j;for(var D=y,t,u,W,E,H=A.contents,v=A.dataTypes;"*"===v[0];)v.shift(),void 0===u&&(u=A.mimeType||D.getResponseHeader("Content-Type"));if(u)for(E in H)if(H[E]&&H[E].test(u)){v.unshift(E);break}if(v[0]in d)W=v[0];else{for(E in d){if(!v[0]||A.converters[E+" "+v[0]]){W=
E;break}t||(t=E)}W=W||t}W?(W!==v[0]&&v.unshift(W),A=d[W]):A=void 0}a:{d=j;t=A;u=y;W=f;var z,I,B,D={},H=d.dataTypes.slice();if(H[1])for(I in d.converters)D[I.toLowerCase()]=d.converters[I];for(E=H.shift();E;)if(d.responseFields[E]&&(u[d.responseFields[E]]=t),!B&&(W&&d.dataFilter)&&(t=d.dataFilter(t,d.dataType)),B=E,E=H.shift())if("*"===E)E=B;else if("*"!==B&&B!==E){I=D[B+" "+E]||D["* "+E];if(!I)for(z in D)if(A=z.split(" "),A[1]===E&&(I=D[B+" "+A[0]]||D["* "+A[0]])){!0===I?I=D[z]:!0!==D[z]&&(E=A[0],
H.unshift(A[1]));break}if(!0!==I)if(I&&d["throws"])t=I(t);else try{t=I(t)}catch(F){A={state:"parsererror",error:I?F:"No conversion from "+B+" to "+E};break a}}A={state:"success",data:t}}if(f)j.ifModified&&((w=y.getResponseHeader("Last-Modified"))&&(h.lastModified[k]=w),(w=y.getResponseHeader("etag"))&&(h.etag[k]=w)),204===a||"HEAD"===j.type?w="nocontent":304===a?w="notmodified":(w=A.state,l=A.data,s=A.error,f=!s);else if(s=w,a||!w)w="error",0>a&&(a=0);y.status=a;y.statusText=(b||w)+"";f?G.resolveWith(q,
[l,w,y]):G.rejectWith(q,[y,w,s]);y.statusCode(P);P=void 0;e&&m.trigger(f?"ajaxSuccess":"ajaxError",[y,j,f?l:s]);C.fireWith(q,[y,w]);e&&(m.trigger("ajaxComplete",[y,j]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var d,f,k,p,r,e,g,s,j=h.ajaxSetup({},b),q=j.context||j,m=j.context&&(q.nodeType||q.jquery)?h(q):h.event,G=h.Deferred(),C=h.Callbacks("once memory"),P=j.statusCode||{},A={},t={},x=0,u="canceled",y={readyState:0,getResponseHeader:function(a){var b;if(2===
x){if(!s)for(s={};b=Rd.exec(p);)s[b[1].toLowerCase()]=b[2];b=s[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===x?p:null},setRequestHeader:function(a,b){var c=a.toLowerCase();x||(a=t[c]=t[c]||a,A[a]=b);return this},overrideMimeType:function(a){x||(j.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>x)for(b in a)P[b]=[P[b],a[b]];else y.always(a[y.status]);return this},abort:function(a){a=a||u;g&&g.abort(a);c(0,a);return this}};G.promise(y).complete=
C.add;y.success=y.done;y.error=y.fail;j.url=((a||j.url||ja)+"").replace(Qd,"").replace(Td,sa[1]+"//");j.type=b.method||b.type||j.method||j.type;j.dataTypes=h.trim(j.dataType||"*").toLowerCase().match(Y)||[""];null==j.crossDomain&&(d=Nc.exec(j.url.toLowerCase()),j.crossDomain=!(!d||!(d[1]!==sa[1]||d[2]!==sa[2]||(d[3]||("http:"===d[1]?"80":"443"))!==(sa[3]||("http:"===sa[1]?"80":"443")))));j.data&&(j.processData&&"string"!==typeof j.data)&&(j.data=h.param(j.data,j.traditional));hc(Oc,j,b,y);if(2===
x)return y;(e=j.global)&&0===h.active++&&h.event.trigger("ajaxStart");j.type=j.type.toUpperCase();j.hasContent=!Sd.test(j.type);k=j.url;j.hasContent||(j.data&&(k=j.url+=(Qb.test(k)?"&":"?")+j.data,delete j.data),!1===j.cache&&(j.url=Mc.test(k)?k.replace(Mc,"$1_="+Pb++):k+(Qb.test(k)?"&":"?")+"_="+Pb++));j.ifModified&&(h.lastModified[k]&&y.setRequestHeader("If-Modified-Since",h.lastModified[k]),h.etag[k]&&y.setRequestHeader("If-None-Match",h.etag[k]));(j.data&&j.hasContent&&!1!==j.contentType||b.contentType)&&
y.setRequestHeader("Content-Type",j.contentType);y.setRequestHeader("Accept",j.dataTypes[0]&&j.accepts[j.dataTypes[0]]?j.accepts[j.dataTypes[0]]+("*"!==j.dataTypes[0]?", "+Pc+"; q=0.01":""):j.accepts["*"]);for(f in j.headers)y.setRequestHeader(f,j.headers[f]);if(j.beforeSend&&(!1===j.beforeSend.call(q,y,j)||2===x))return y.abort();u="abort";for(f in{success:1,error:1,complete:1})y[f](j[f]);if(g=hc(lb,j,b,y)){y.readyState=1;e&&m.trigger("ajaxSend",[y,j]);j.async&&0<j.timeout&&(r=setTimeout(function(){y.abort("timeout")},
j.timeout));try{x=1,g.send(A,c)}catch(H){if(2>x)c(-1,H);else throw H;}}else c(-1,"No Transport");return y},getJSON:function(a,b,c){return h.get(a,b,c,"json")},getScript:function(a,b){return h.get(a,void 0,b,"script")}});h.each(["get","post"],function(a,b){h[b]=function(a,c,d,f){h.isFunction(c)&&(f=f||d,d=c,c=void 0);return h.ajax({url:a,type:b,dataType:f,data:c,success:d})}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.on(b,
...
Jmol._version||(Jmol=function(a){var m=function(a){return{header:a++,rear:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,monitorZIndex:a+99999}},m={_version:"JSmol 14.3.6_2014.08.14",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:m,_z:m(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",
...
a._alertNoBinary&&!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes=".gz .jpg .png .zip .jmol .bin .smol .spartan .mrc .pse .map .omap".split(" ");a._isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c,d){var e=a._isBinaryUrl(b),k=0<=b.indexOf("pdb.gz")&&0==b.indexOf("http://www.rcsb.org/pdb/files/"),r=e&&!a._canSyncBinary(k);
r&&k&&(b=b.replace(/pdb\.gz/,"pdb"),r=e=!1);k=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var g=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),j=a._isDirectCall(b),q=!g&&a.$supportsIECrossDomainScripting(),m=null;if((!c||r)&&(q||r||!g&&!j))m=a._getRawDataFromServer("_",b,c,c,r,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var x={dataType:e?"binary":"text",async:!!c};k?(x.type="POST",x.url=
b.split("?POST?")[0],x.data=b.split("?POST?")[1]):(x.type="GET",x.url=b);c&&(x.success=function(){c(a._xhrReturn(x.xhr))},x.error=function(){c(xhr.statusText)});x.xhr=a.$ajax(x);c||(m=a._xhrReturn(x.xhr))}if(!d)return m;null==m&&(m="",e=!1);e&&(e=a._canSyncBinary(!0));return e?a._strToBytes(m):JU.SB.newS(m)};a._xhrReturn=function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){for(var c in a.db._DirectDatabaseCalls)if(0<=
c.indexOf(".")&&0<=b.indexOf(c))return!0;return!1};a._cleanFileData=function(a){return 0<=a.indexOf("\r")&&0<=a.indexOf("\n")?a.replace(/\r\n/g,"\n"):0<=a.indexOf("\r")?a.replace(/\r/g,"\n"):a};a._getFileType=function(a){var c=a.substring(0,1);if("$"==c||":"==c)return"MOL";if("="==c)return"="==a.substring(1,2)?"LCIF":"PDB";a=a.split(".").pop().toUpperCase();return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,c){return b&&b._z&&b._z[c]||a._z[c]};a._incrZ=function(b,c){return b&&b._z&&++b._z[c]||
++a._z[c]};a._loadFileAsynchronously=function(b,c,d,e){if(0!=d.indexOf("?")){d=a._checkFileName(c,d);var k=function(c){a._setData(b,d,c,e)},k=a._checkCache(c,d,k);return null==k?null:a._getFileData(d,k)}if(!a.featureDetection.hasFileReader)return b.setData("Local file reading is not enabled in your browser",null,e);c._localReader||(k='<div id="ID" style="z-index:'+a._getZ(c,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',
...
a._getZ(b,"coverImage")+';opacity:0.5;"'+d+" />",e='<div id="ID_coverdiv" style="background-color:red;z-index:'+a._getZ(b,"coverImage")+';width:100%;height:100%;display:inline;position:absolute;top:0px;left:0px"><image id="ID_coverimage" src="'+b._coverImage+'" style="width:100%;height:100%"'+d+"/>"+e+"</div>");d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG......<div id="ID_appletdiv" style="z-index:'+a._getZ(b,"header")+';width:100%;height:100%;position:absolute;top:0px;left:0px;">';
var k=b._height,r=b._width;if("string"!==typeof k||0>k.indexOf("%"))k+="px";if("string"!==typeof r||0>r.indexOf("%"))r+="px";d=d.replace(/IMG/,e).replace(/Hpx/g,k).replace(/Wpx/g,r)}else d='......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
...
a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(c,"appletdiv","drop",function(d){var e=d.originalEvent;e.stopPropagation();e.preventDefault();var g=e.dataTransfer.files[0];if(null==g)try{g=""+e.dataTransfer.getData("text"),(0==g.indexOf("file:/")||0==g.indexOf("http:/"))&&c._scriptLoad(g)}catch(k){}else e=new FileReader,e.onloadend=function(k){if(k.target.readyState==FileReader.DONE){var e="cache://DROP_"+g.name;k=a._toBytes(k.target.result);e.endsWith(".spt")||c._applet.cacheFileByName("cache://DROP_*",
!1);"JSV"==c._viewType||e.endsWith(".jdx")?a.Cache.put(e,k):c._applet.cachePut(e,k);(k=a._jsGetXY(c._canvas,d))&&(!c._applet.setStatusDragDropped||c._applet.setStatusDragDropped(0,k[0],k[1],e))&&c._applet.openFileAsyncSpecial(e,1)}},e.readAsArrayBuffer(g)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
function(m,g,j,e){this._uniqueId=(""+Math.random()).substring(3);this._id=m;this._is2D=!0;this._isJava=!1;this._jmolType="Jmol._Canvas2D ("+j+")";switch(j){case "Jmol":this._platform="J.awtjs2d.Platform";break;case "JSV":this._isLayered=this._isJSV=!0;this._platform="JSV.awtjs2d.Platform";break;case "Astex":this._isAstex=!0,this._platform="astex.awtjs2d.Platform"}if(e)return this;window[m]=this;this._createCanvas(m,g);if(!a._document||this._deferApplet)return this;this._init();return this};a._setAppletParams=
function(m,g,j,e){for(var q in j)if(!m||0<=m.indexOf(";"+q.toLowerCase()+";"))null==j[q]||"language"==q&&!a.featureDetection.supportsLocalization()||(e?g.put(q,!0===j[q]?Boolean.TRUE:!1===j[q]?Boolean.FALSE:j[q]):g[q]=j[q])};a._jsSetPrototype=function(m){m._init=function(){this._setupJS();this._showInfo(!0);this._disableInitialConsole&&this._showInfo(!1)};m._createCanvas=function(g,j,e){a._setObject(this,g,j);e&&(this._GLmol=e,this._GLmol.applet=this,this._GLmol.id=this._id);e=a._getWrapper(this,
!0);this._deferApplet||(a._document?(a._documentWrite(e),this._newCanvas(!1),e=""):(this._deferApplet=!0,e+='<script type="text/javascript">'+g+"._cover(false)\x3c/script>"));e+=a._getWrapper(this,!1);j.addSelectionOptions&&(e+=a._getGrabberOptions(this));a._debugAlert&&!a._document&&alert(e);this._code=a._documentWrite(e)};m._cover=function(g){if(g||!this._deferApplet)this._displayCoverImage(g);else{var j=this._coverScript?this._coverScript:"";this._coverScript="";this._deferUncover&&(j+=";refresh;javascript "+
...
g?"block":"none")};m._newCanvas=function(a){this._is2D?this._createCanvas2d(a):this._GLmol.create()};m._createCanvas2d=function(){var g=a.$(this,"appletdiv");try{g[0].removeChild(this._canvas),this._canvas.frontLayer&&g[0].removeChild(this._canvas.frontLayer),this._canvas.rearLayer&&g[0].removeChild(this._canvas.rearLayer),this._canvas.imageLayer&&g[0].removeChild(this._canvas.imageLayer),a._jsUnsetMouse(this._mouseInterface)}catch(j){}var e=Math.round(g.width()),q=Math.round(g.height()),d=document.createElement("canvas");
d.applet=this;this._canvas=d;d.style.width="100%";d.style.height="100%";d.width=e;d.height=q;d.id=this._id+"_canvas2d";g.append(d);a._$(d.id).css({"z-index":a._getZ(this,"main")});if(this._isLayered){var c=document.createElement("div");d.imageLayer=c;c.id=this._id+"_imagelayer";g.append(c);a._$(c.id).css({zIndex:a._getZ(this,"image"),position:"absolute",left:"0px",top:"0px",width:"0px",height:"0px",overflow:"hidden"});this._mouseInterface=this._getLayer("front",g,e,q,!1)}else this._mouseInterface=
d;a._jsSetMouse(this._mouseInterface)};m._getLayer=function(g,j,e,q,d){var c=document.createElement("canvas");this._canvas[g+"Layer"]=c;c.style.width="100%";c.style.height="100%";c.id=this._id+"_"+g+"Layer";c.width=e;c.height=q;j.append(c);c.applet=this;a._$(c.id).css({background:d?"rgb(0,0,0,1)":"rgb(0,0,0,0.001)","z-index":a._getZ(this,g),position:"absolute",left:"0px",top:"0px",overflow:"hidden"});return c};m._setupJS=function(){window["j2s.lib"]={base:this._j2sPath+"/",alias:".",console:this._console,
...
a.__execDelayMS)};m.__startAppletJS=function(g){var j=new java.util.Hashtable;a._setAppletParams(g._availableParams,j,g.__Info,!0);j.put("appletReadyCallback","Jmol._readyCallback");j.put("applet",!0);j.put("name",g._id);j.put("syncId",a._syncId);g._color&&j.put("bgcolor",g._color);g._is2D?g._startupScript&&j.put("script",g._startupScript):j.put("script","set multipleBondSpacing 0.35;");a._syncedApplets.length&&j.put("synccallback","Jmol._mySyncCallback");j.put("signedApplet","true");j.put("platform",
g._platform);g._is2D&&j.put("display",g._id+"_canvas2d");j.put("documentBase",document.location.href);var e=g._j2sPath+"/";if(0>e.indexOf("://")){var q=document.location.href.split("#")[0].split("?")[0].split("/");0==e.indexOf("/")?q=[q[0],e.substring(1)]:q[q.length-1]=e;e=q.join("/")}j.put("codePath",e);a._registerApplet(g._id,g);g._applet=g._isAstex?new astex.MoleculeViewerAppletJS(j):!g._isJSV?new J.appletjs.Jmol(j):g._isPro?new JSV.appletjs.JSVAppletPro(j):new JSV.appletjs.JSVApplet(j);g._is2D||
(g._GLmol.applet=g);g._jsSetScreenDimensions();a.__nextExecution()};m._jsSetScreenDimensions=function(){if(this._applet){var g=a._getElement(this,this._is2D?"canvas2d":"canvas");this._applet.setScreenDimension(g.width,g.height)}};m._show=function(g){a.$setVisible(a.$(this,"appletdiv"),g);g&&a._repaint(this,!0)};m._canScript=function(){return!0};m._delay=function(a,j,e){this._delayID=setTimeout(function(){a.resumeEval(j,!1)},e)};m._createDomNode=function(a,j){a=this._id+"_"+a;var e=document.getElementById(a);
e&&document.body.removeChild(e);if(j){0==j.indexOf("<?")&&(j=j.substring(j.indexOf("<",1)));if(0<=j.indexOf("/>")){for(var e=j.split("/>"),q=e.length-1;0<=--q;)for(var d=e[q],c=d.lastIndexOf("<")+1,b=c,f=d.length,p="";++b<f;)if(0<=" \t\n\r".indexOf(d.charAt(b))){p=d.substring(c,b);e[q]=d+"></"+p+">";break}j=e.join("")}e=document.createElement("_xml");e.id=a;e.innerHTML=j;e.style.display="none";document.body.appendChild(e);return e}};m.equals=function(a){return this==a};m.clone=function(){return this};
m.hashCode=function(){return parseInt(this._uniqueId)};m._processGesture=function(a){return this._applet.mouse.processTwoPointGesture(a)};m._processEvent=function(a,j){this._applet.processMouseEvent(a,j[0],j[1],j[2],System.currentTimeMillis())};m._resize=function(){var g="__resizeTimeout_"+this._id;a[g]&&clearTimeout(a[g]);var j=this;a[g]=setTimeout(function(){a._repaint(j,!0);a[g]=null},100)};return m};a._repaint=function(m,g){if(m&&m._applet){var j=a.$(m,"appletdiv"),e=Math.round(j.width()),j=Math.round(j.height());
if(m._is2D&&(m._canvas.width!=e||m._canvas.height!=j))m._newCanvas(!0),m._applet.setDisplay(m._canvas);m._applet.setScreenDimension(e,j);g?setTimeout(function(){m._applet&&m._applet.update()}):m._applet.update()}};a._getHiddenCanvas=function(a,g,j,e,q){g=a._id+"_"+g;(a=document.getElementById(g))&&q&&(a=null);a||(a=document.createElement("canvas"));a.width=a.style.width=j;a.height=a.style.height=e;a.id!=g&&(a.id=g);return a};a._loadImage=function(m,g,j,e,q){var d=g[1];if(null==q)return q=new Image,
q.onload=function(){a._loadImage(m,g,null,e,q)},null!=j&&(j=J.io.Base64.getBase64(j).toString(),j=d.substring(url.lastIndexOf("/")+1),0<=j.indexOf(".png")||j.indexOf(".jpg")),q.src=d,!0;j=q.width;var c=q.height,b="echo_"+g[0],f=a._getHiddenCanvas(m.vwr.html5Applet,b,j,c,!0);f.imageWidth=j;f.imageHeight=c;f.id=b;f.image=q;a._setCanvasImage(f,j,c);e(f,d)};a._setCanvasImage=function(a,g,j){a.buf32=null;a.width=g;a.height=j;a.getContext("2d").drawImage(a.image,0,0,g,j)}})(Jmol);
...
g._noJavaMsg+"</p></object>\n":"<applet "+f+" code='"+d.code+"' codebase='"+e._jarPath+"' archive='"+c+"' mayscript='true'>\n"+p+"<table bgcolor='yellow'><tr><td align='center' valign='middle' "+b+">\n"+g._noJavaMsg+"</td></tr></table></applet>\n";p=a._getWrapper(e,!0)+p+a._getWrapper(e,!1)+(j.addSelectionOptions?a._getGrabberOptions(e):"");a._debugAlert&&alert(p);e._code=a._documentWrite(p)};j._create=function(e,j){a._setObject(this,e,j);var d={syncId:a._syncId,progressbar:"true",progresscolor:"blue",
boxbgcolor:this._color||"black",boxfgcolor:"white",boxmessage:"Downloading JmolApplet ...",script:this._color?'background "'+this._color+'"':"",code:"JmolApplet.class"};a._setAppletParams(this._availableParams,d,j);var c;j.inlineModel?(c=j.inlineModel,c=c.replace(/\r|\n|\r\n/g,0<=c.indexOf("|")?"\\/n":"|").replace(/'/g,"&#39;"),a._debugAlert&&alert("inline model:\n"+c)):c="";d.loadInline=c;d.appletReadyCallback="Jmol._readyCallback";a._syncedApplets.length&&(d.synccallback="Jmol._mySyncCallback");
d.java_arguments="-Xmx"+Math.round(j.memoryLimit||this._memoryLimit)+"m";this._initialize(j.jarPath,j.jarFile);g._createApplet(this,j,d)};j._readyCallback=function(e,g,d,c){d&&(a._setDestroy(this),this._ready=!0,e=this._readyScript,this._applet=c,this._defaultModel?a._search(this,this._defaultModel,e?";"+e:""):e?this._script(e):this._src&&this._script('load "'+this._src+'"'),this._showInfo(!0),this._showInfo(!1),a.Cache.setDragDrop(this),this._readyFunction&&this._readyFunction(this),a._setReady(this),
(c=this._2dapplet)&&(c._isEmbedded&&c._ready&&c.__Info.visible)&&this._show2d(!0))};j._showInfo=function(e){e&&this._2dapplet&&this._2dapplet._show(!1);a.$html(a.$(this,"infoheaderspan"),this._infoHeader);this._info&&a.$html(a.$(this,"infodiv"),this._info);if(!this._isInfoVisible!=!e){this._isInfoVisible=e;if(this._isJava){var g=e?2:"100%";a.$setSize(a.$(this,"appletdiv"),g,g)}a.$setVisible(a.$(this,"infotablediv"),e);a.$setVisible(a.$(this,"infoheaderdiv"),e);this._show(!e)}};j._show2d=function(a){this._2dapplet._show2d(a);
this._2dapplet._isEmbedded&&(this._showInfo(!1),this._show(!a))};j._getAtomCorrelation=function(a){this._loadMolData(a,"atommap = compare({1.1} {2.1} 'MAP' 'H'); zap 2.1",!0);a=jmol._evaluate("atommap");for(var g=jmol._evaluate("{*}.count"),d=[],c=[],b=0;b<a.length;b++){var f=a[b];d[f[0]+1]=f[1]-g+1;c[f[1]-g+1]=f[0]+1}return{fromJmol:d,toJmol:c}};j._show=function(e){var g=!e?2:"100%";a.$setSize(a.$(this,"object"),g,g);this._isJava||a.$setVisible(a.$(this,"appletdiv"),e)};j._clearConsole=function(){this._console==
this._id+"_infodiv"&&(this.info="");self.Clazz&&(a._setConsoleDiv(this._console),Clazz.Console.clear())};j._addScript=function(a){this._readyScript||(this.readyScript="");this._readyScript&&(this._readyScript+=";");this._readyScript+=a;return!0};j._script=function(e){if(!this._ready)return this._addScript(e);a._setConsoleDiv(this._console);this._applet.script(e)};j._syncScript=function(a){this._applet.syncScript(a)};j._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};j._scriptWait=
function(a,g){var d=this._scriptWaitAsArray(a),c="";if(!g)for(var b=d.length;0<=--b;)for(var f=0,j=d[b].length;f<j;f++)c+=d[b][f]+"\n";return c};j._scriptEcho=function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptEcho"==a[d][c][1]&&(g+=a[d][c][3]+"\n");return g.replace(/ \| /g,"\n")};j._scriptMessage=function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptStatus"==a[d][c][1]&&(g+=a[d][c][3]+
"\n");return g.replace(/ \| /g,"\n")};j._scriptWaitOutput=function(a){var g="";try{a&&(g+=this._applet.scriptWaitOutput(a))}catch(d){}return g};j._scriptWaitAsArray=function(e){var g="";try{if(this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"),e&&(g+=this._applet.scriptWait(e),g=a._evalJSON(g,"jmolStatus"),"object"==typeof g))return g}catch(d){}return[[g]]};j._getStatus=function(e){return a._sortMessages(this._getPropertyAsArray("jmolStatus",e))};j._getPropertyAsArray=function(e,
g){return a._evalJSON(this._getPropertyAsJSON(e,g),e)};j._getPropertyAsString=function(a,g){void 0==g&&(g="");return this._applet.getPropertyAsString(a,g)+""};j._getPropertyAsJSON=function(a,g){void 0==g&&(g="");try{return this._applet.getPropertyAsJSON(a,g)+""}catch(d){return""}};j._getPropertyAsJavaObject=function(a,g){void 0==g&&(g="");return this._applet.getProperty(a,g)};j._evaluate=function(a){null!=a||(a="");return this._getPropertyAsArray("variableInfo",a)};j._evaluateDEPRECATED=function(a){a=
""+this._getPropertyAsJavaObject("evaluate",a);var g=a.replace(/\-*\d+/,"");if(""==g&&!isNaN(parseInt(a)))return parseInt(a);g=a.replace(/\-*\d*\.\d*/,"");return""==g&&!isNaN(parseFloat(a))?parseFloat(a):a};j._saveOrientation=function(a){return this._savedOrientations[a]=this._getPropertyAsArray("orientationInfo","info").moveTo};j._restoreOrientation=function(a){a=this._savedOrientations[a];return!a||""==a?a.replace(/1\.0/,"0"):this._scriptWait(a)};j._restoreOrientationDelayed=function(a,g){1>arguments.length&&
(g=1);var d=this._savedOrientations[a];return!d||""==d?d.replace(/1\.0/,g):this._scriptWait(d)};j._resizeApplet=function(e){function g(c,b){var d=""+c;return 0==d.length?b?"":a._allowedJmolSize[2]:d.indexOf("%")==d.length-1?d:1>=(c=parseFloat(c))&&0<c?100*c+"%":(isNaN(c=Math.floor(c))?a._allowedJmolSize[2]:c<a._allowedJmolSize[0]?a._allowedJmolSize[0]:c>a._allowedJmolSize[1]?a._allowedJmolSize[1]:c)+(b?b:"")}var d;"object"==typeof e&&null!=e?(d=e[0]||e.width,e=e[1]||e.height):d=e;d=[g(d,"px"),g(e,
"px")];e=a._getElement(this,"appletinfotablediv");e.style.width=d[0];e.style.height=d[1];this._containerWidth=d[0];this._containerHeight=d[1];this._is2D&&a._repaint(this,!0)};j._search=function(e,g){a._search(this,e,g)};j._searchDatabase=function(e,g,d){if(this._2dapplet&&this._2dapplet._isEmbedded&&a.$(this,"2dappletdiv:visible")[0])return this._2dapplet._searchDatabase(e,g,d);this._showInfo(!1);0<=e.indexOf("?")?a._getInfoFromDatabase(this,g,e.split("?")[0]):(d||(d=a._getScriptForDatabase(g)),e=
...
d?this._script('load async "'+a+'";'+g):this._applet.openFile(a);this._checkDeferred("");return!0};j.__loadModel=function(e,g,d){null!=e&&(null!=this._viewSet&&(g||(g=""),g+=";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};"),!g&&this._noscript?this._applet.loadInlineString(e,"",!1):this._loadMolData(e,g,!1),null!=this._viewSet&&a.View.updateView(this,{chemID:d,data:e}))};j._loadMolData=function(a,g,d){g||
(g="");d=d?"append":"model";this._applet.scriptWait('load DATA "'+d+'"'+a+'\nEND "'+d+'" ;'+g)};j._loadModelFromView=function(e){this._currentView=e;var g=e.Jmol;null!=g.data?this.__loadModel(g.data,null,e.info.chemID):null!=e.info.chemID?a._searchMol(this,e.info.chemID,null,!1):(g=e.JME)&&g.applet._show2d(!1,this)};j._updateView=function(){null!=this._viewSet&&this._applet&&(chemID=""+this._getPropertyAsJavaObject("variableInfo","script('show chemical inchiKey')"),chemID=36>chemID.length()?null:
chemID.substring(36).split("\n")[0],a.View.updateView(this,{chemID:chemID,data:""+this._getPropertyAsJavaObject("evaluate","extractModel","{visible}")}))};j._atomPickedCallback=function(e,g){if(!(0>g)){var d=[g+1];a.View.updateAtomPick(this,d);this._updateAtomPick(d)}};j._updateAtomPick=function(a){this._script(0==a.length?"select none":"select on visible and (@"+a.join(",@")+")")};j._isDeferred=function(){return!this._canvas&&this._cover&&this._isCovered&&this._deferApplet};j._checkDeferred=function(a){return this._isDeferred()?
(this._coverScript=a,this._cover(!1),!0):!1};j._getSmiles=function(){return this._evaluate("{visible}.find('SMILES')")};j._getMol=function(){return this._evaluate("getProperty('ExtractModel',{visible})")};j._getMol2D=function(){return jmol._evaluate("script('select visible;show chemical sdf')")};a.jmolSmiles=function(a){return a._getSmiles()}})(Jmol,document);
...
break}if(0==k.length)return new a.MethodException;j=a.searchMethod(k,f);if(null!=j){k=null;k=r?b:b["\\"+j];r=null;if(f.hasCastedNull){r=[];for(j=0;j<e.length;j++)r[j]=e[j]instanceof a.CastedNull?null:e[j]}else r=e;if(a.tracingCalling){m=arguments.callee.caller;m=m=m.arguments.callee.caller;if(j="construct"==k.exName&&0<=a.getInheritedLevel(k.exClazz,Throwable)&&!a._initializingException){a._initializingException=!0;var q=m.arguments.callee.caller.arguments.callee.caller,A=q.arguments.callee,x=A.claxxReference;
null==x&&(x=A.exClazz);null==x&&(x=A.claxxOwner);a.pu$hCalling(new a.callingStack(q,x))}if(q=m!==a.instantialize&&m!==a.superCall)A=m.arguments.callee,x=A.claxxReference,null==x&&(x=A.exClazz),null==x&&(x=A.claxxOwner),a.pu$hCalling(new a.callingStack(m,x));g.lastMethod=k;k=k.apply(c,r);q&&a.p0pCalling();j&&a.p0pCalling();return k}g.lastMethod=k;return k.apply(c,r)}return new a.MethodException};a._initializingException=!1;a.searchMethod=function(d,c){for(var b=[],f=0;f<d.length;f++){for(var e=[],
...
arguments.length,b=(c-1)/2;0<=--b;){var e=arguments[--c],g=arguments[--c];a[g]=a.prototype[g]=e}};a.prepareFields=function(d,c){var b=[];if(null!=d.con$truct)for(var e=d.con$truct.stacks,g=0;g<e.length;g++)b[g]=e[g];a.addProto(d.prototype,"con$truct",d.con$truct=function(){var a=arguments.callee.stacks;if(null!=a)for(var c=0;c<a.length;c++)a[c].apply(this,[])});b[b.length]=c;d.con$truct.stacks=b;d.con$truct.index=0};a.registerSerializableFields=function(a){var c=arguments,b=c.length,e=[];if(null!=
...
127)+1):a&255};a.charCast=function(a){return String.fromCharCode(a&255).charAt(0)};a.floatCast=function(a){return a};a.longMasks=[];a.longReverseMasks=[];a.longBits=[];m=[1];for(g=1;53>g;g++)m[g]=m[g-1]+m[g-1];a.longBits=m;a.longMasks[52]=m[52];for(g=51;0<=g;g--)a.longMasks[g]=a.longMasks[g+1]+m[g];a.longReverseMasks[0]=m[0];for(g=1;52>g;g++)a.longReverseMasks[g]=a.longReverseMasks[g-1]+m[g];a.longLeftShift=function(d,c){if(0==c)return d;if(64<=c)return 0;if(52<c)return error("[Java2Script] Error : JavaScript does not support long shift!"),
...
b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++;else try{m=b.childNodes[b.childNodes.length-1]}catch(G){m=document.createElement("DIV"),b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++}var C=document.createElement("SPAN");m.appendChild(C);C.style.whiteSpace="nowrap";null!=c&&(C.style.color=c);0==j[e].length&&(j[e]=String.fromCharCode(160));C.appendChild(document.createTextNode(j[e]));q.pinning||(b.scrollTop+=100);q.metLineBreak=e!=j.length-1?!0:g}g=b.parentNode.className;!q.pinning&&
...
function(a){q.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};System.out.write=function(a,c,b){System.out.print(String.instantialize(a).substring(c,c+b))};System.err.__CLASS_NAME__="java.io.PrintStream";System.err.print=function(a){q.consoleOutput(a,"red")};System.err.println=function(a){q.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};System.err.write=function(a,c,b){System.err.print(String.instantialize(a).substring(c,c+b))};a.setConsoleDiv=
function(a){window["j2s.lib"]&&(window["j2s.lib"].console=a)};a.binaryFolders=a._Loader.binaryFolders=[a._Loader.getJ2SLibBase()]}(Clazz))};___JmolDate="$Date: 2014-08-14 15:07:40 -0500 (Thu, 14 Aug 2014) $";___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";___JmolVersion="14.3.6_2014.08.14";
