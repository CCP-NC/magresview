...
!0;b<c;b++)e.tweens[b].run(1);a?q.resolveWith(l,[e,a]):q.rejectWith(l,[e,a]);return this}});a=e.props;b=e.opts.specialEasing;var g,k,s,m;for(c in a)if(g=h.camelCase(c),k=b[g],s=a[c],h.isArray(s)&&(k=s[1],s=a[c]=s[0]),c!==g&&(a[g]=s,delete a[c]),(m=h.cssHooks[g])&&"expand"in m)for(c in s=m.expand(s),delete a[g],s)c in a||(a[c]=s[c],b[c]=k);else b[g]=k;for(;f<j;f++)if(c=Na[f].call(e,l,a,e.opts))return c;h.map(a,ec,e);h.isFunction(e.opts.start)&&e.opts.start.call(l,e);h.fx.timer(h.extend(r,{elem:l,anim:e,
...
yc={};h.Callbacks=function(a){var b;if("string"===typeof a){if(!(b=yc[a])){b=a;var c=yc[b]={};h.each(b.match(Y)||[],function(a,b){c[b]=!0});b=c}}else b=h.extend({},a);a=b;var d,f,j,q,r,e,g=[],s=!a.once&&[],k=function(b){f=a.memory&&b;j=!0;r=e||0;e=0;q=g.length;for(d=!0;g&&r<q;r++)if(!1===g[r].apply(b[0],b[1])&&a.stopOnFalse){f=!1;break}d=!1;g&&(s?s.length&&k(s.shift()):f?g=[]:m.disable())},m={add:function(){if(g){var b=g.length;(function Zc(b){h.each(b,function(b,c){var d=h.type(c);"function"===d?
(!a.unique||!m.has(c))&&g.push(c):c&&(c.length&&"string"!==d)&&Zc(c)})})(arguments);d?q=g.length:f&&(e=b,k(f))}return this},remove:function(){g&&h.each(arguments,function(a,b){for(var c;-1<(c=h.inArray(b,g,c));)g.splice(c,1),d&&(c<=q&&q--,c<=r&&r--)});return this},has:function(a){return a?-1<h.inArray(a,g):!(!g||!g.length)},empty:function(){g=[];q=0;return this},disable:function(){g=s=f=void 0;return this},disabled:function(){return!g},lock:function(){s=void 0;f||m.disable();return this},locked:function(){return!s},
fireWith:function(a,b){if(g&&(!j||s))b=b||[],b=[a,b.slice?b.slice():b],d?s.push(b):k(b);return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!j}};return m};h.extend({Deferred:function(a){var b=[["resolve","done",h.Callbacks("once memory"),"resolved"],["reject","fail",h.Callbacks("once memory"),"rejected"],["notify","progress",h.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){f.done(arguments).fail(arguments);return this},then:function(){var a=
...
Cc=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,b,c,d,f){var j,q,r,e,g,s,k,m,p;if(r=h._data(a)){c.handler&&(e=c,c=e.handler,f=e.selector);c.guid||(c.guid=h.guid++);if(!(q=r.events))q=r.events={};if(!(g=r.handle))g=r.handle=function(a){return typeof h!==R&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):void 0},g.elem=a;b=(b||"").match(Y)||[""];for(r=b.length;r--;)if(j=Cc.exec(b[r])||[],m=s=j[1],p=(j[2]||"").split(".").sort(),m){j=h.event.special[m]||{};m=(f?j.delegateType:
j.bindType)||m;j=h.event.special[m]||{};s=h.extend({type:m,origType:s,data:d,handler:c,guid:c.guid,selector:f,needsContext:f&&h.expr.match.needsContext.test(f),namespace:p.join(".")},e);if(!(k=q[m]))if(k=q[m]=[],k.delegateCount=0,!j.setup||!1===j.setup.call(a,d,p,g))a.addEventListener?a.addEventListener(m,g,!1):a.attachEvent&&a.attachEvent("on"+m,g);j.add&&(j.add.call(a,s),s.handler.guid||(s.handler.guid=c.guid));f?k.splice(k.delegateCount++,0,s):k.push(s);h.event.global[m]=!0}a=null}},remove:function(a,
b,c,d,f){var j,q,r,e,g,s,k,m,p,G,A,P=h.hasData(a)&&h._data(a);if(P&&(s=P.events)){b=(b||"").match(Y)||[""];for(g=b.length;g--;)if(r=Cc.exec(b[g])||[],p=A=r[1],G=(r[2]||"").split(".").sort(),p){k=h.event.special[p]||{};p=(d?k.delegateType:k.bindType)||p;m=s[p]||[];r=r[2]&&RegExp("(^|\\.)"+G.join("\\.(?:.*\\.|)")+"(\\.|$)");for(e=j=m.length;j--;)if(q=m[j],(f||A===q.origType)&&(!c||c.guid===q.guid)&&(!r||r.test(q.namespace))&&(!d||d===q.selector||"**"===d&&q.selector))m.splice(j,1),q.selector&&m.delegateCount--,
k.remove&&k.remove.call(a,q);e&&!m.length&&((!k.teardown||!1===k.teardown.call(a,G,P.handle))&&h.removeEvent(a,p,P.handle),delete s[p])}else for(p in s)h.event.remove(a,p+b[g],c,d,!0);h.isEmptyObject(s)&&(delete P.handle,h._removeData(a,"events"))}},trigger:function(b,c,d,f){var j,q,r,e,g,s,k=[d||u],m=ua.call(b,"type")?b.type:b;g=ua.call(b,"namespace")?b.namespace.split("."):[];r=j=d=d||u;if(!(3===d.nodeType||8===d.nodeType)&&!Bc.test(m+h.event.triggered))if(0<=m.indexOf(".")&&(g=m.split("."),m=g.shift(),
g.sort()),q=0>m.indexOf(":")&&"on"+m,b=b[h.expando]?b:new h.Event(m,"object"===typeof b&&b),b.isTrigger=f?2:3,b.namespace=g.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:h.makeArray(c,[b]),g=h.event.special[m]||{},f||!(g.trigger&&!1===g.trigger.apply(d,c))){if(!f&&!g.noBubble&&!h.isWindow(d)){e=g.delegateType||m;Bc.test(e+m)||(r=r.parentNode);for(;r;r=r.parentNode)k.push(r),j=r;if(j===(d.ownerDocument||
u))k.push(j.defaultView||j.parentWindow||a)}for(s=0;(r=k[s++])&&!b.isPropagationStopped();)if(b.type=1<s?e:g.bindType||m,(j=(h._data(r,"events")||{})[b.type]&&h._data(r,"handle"))&&j.apply(r,c),(j=q&&r[q])&&j.apply&&h.acceptData(r))b.result=j.apply(r,c),!1===b.result&&b.preventDefault();b.type=m;if(!f&&!b.isDefaultPrevented()&&(!g._default||!1===g._default.apply(k.pop(),c))&&h.acceptData(d)&&q&&d[m]&&!h.isWindow(d)){(j=d[q])&&(d[q]=null);h.event.triggered=m;try{d[m]()}catch(p){}h.event.triggered=
...
a.nodeName+">")?j=a.cloneNode(!0):(Gb.innerHTML=a.outerHTML,Gb.removeChild(j=Gb.firstChild));if((!t.noCloneEvent||!t.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!h.isXMLDoc(a)){d=A(j);r=A(a);for(q=0;null!=(f=r[q]);++q)if(d[q]){var g=d[q],s=void 0,m=void 0,k=void 0;if(1===g.nodeType){s=g.nodeName.toLowerCase();if(!t.noCloneEvent&&g[h.expando]){k=h._data(g);for(m in k.events)h.removeEvent(g,m,k.handle);g.removeAttribute(h.expando)}if("script"===s&&g.text!==f.text)D(g).text=f.text,H(g);else if("object"===
s)g.parentNode&&(g.outerHTML=f.outerHTML),t.html5Clone&&(f.innerHTML&&!h.trim(g.innerHTML))&&(g.innerHTML=f.innerHTML);else if("input"===s&&kb.test(f.type))g.defaultChecked=g.checked=f.checked,g.value!==f.value&&(g.value=f.value);else if("option"===s)g.defaultSelected=g.selected=f.defaultSelected;else if("input"===s||"textarea"===s)g.defaultValue=f.defaultValue}}}if(b)if(c){r=r||A(a);d=d||A(j);for(q=0;null!=(f=r[q]);q++)Tb(f,d[q])}else Tb(a,j);d=A(j,"script");0<d.length&&I(d,!e&&A(a,"script"));return j},
buildFragment:function(a,b,c,d){for(var f,j,q,r,e,g,s=a.length,m=G(b),k=[],p=0;p<s;p++)if((j=a[p])||0===j)if("object"===h.type(j))h.merge(k,j.nodeType?[j]:j);else if(Bd.test(j)){q=q||m.appendChild(b.createElement("div"));r=(Fc.exec(j)||["",""])[1].toLowerCase();g=Q[r]||Q._default;q.innerHTML=g[1]+j.replace(Ec,"<$1></$2>")+g[2];for(f=g[0];f--;)q=q.lastChild;!t.leadingWhitespace&&Fb.test(j)&&k.push(b.createTextNode(Fb.exec(j)[0]));if(!t.tbody)for(f=(j="table"===r&&!Gc.test(j)?q.firstChild:"<table>"===
g[1]&&!Gc.test(j)?q:0)&&j.childNodes.length;f--;)h.nodeName(e=j.childNodes[f],"tbody")&&!e.childNodes.length&&j.removeChild(e);h.merge(k,q.childNodes);for(q.textContent="";q.firstChild;)q.removeChild(q.firstChild);q=m.lastChild}else k.push(b.createTextNode(j));q&&m.removeChild(q);t.appendChecked||h.grep(A(k,"input"),P);for(p=0;j=k[p++];)if(!(d&&-1!==h.inArray(j,d))&&(a=h.contains(j.ownerDocument,j),q=A(m.appendChild(j),"script"),a&&I(q),c))for(f=0;j=q[f++];)Hc.test(j.type||"")&&c.push(j);return m},
cleanData:function(a,b){for(var c,d,f,j,q=0,r=h.expando,e=h.cache,g=t.deleteExpando,s=h.event.special;null!=(c=a[q]);q++)if(b||h.acceptData(c))if(j=(f=c[r])&&e[f]){if(j.events)for(d in j.events)s[d]?h.event.remove(c,d):h.removeEvent(c,d,j.handle);e[f]&&(delete e[f],g?delete c[r]:typeof c.removeAttribute!==R?c.removeAttribute(r):c[r]=null,$.push(f))}}});h.fn.extend({text:function(a){return qa(this,function(a){return void 0===a?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},
...
N.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};h.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};h.fx=N.prototype.init;h.fx.step={};var ta,fb,Kd=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([+-])=|)("+Ya+")([a-z%]*)$","i"),Ld=/queueHooks$/,Na=[function(a,b,c){var d,f,j,q,r,e,g=this,s={},m=a.style,k=a.nodeType&&Ca(a),p=h._data(a,"fxshow");c.queue||(q=h._queueHooks(a,"fx"),null==q.unqueued&&(q.unqueued=0,r=q.empty.fire,
q.empty.fire=function(){q.unqueued||r()}),q.unqueued++,g.always(function(){g.always(function(){q.unqueued--;h.queue(a,"fx").length||q.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))c.overflow=[m.overflow,m.overflowX,m.overflowY],f=h.css(a,"display"),e=Vb(a.nodeName),"none"===f&&(f=e),"inline"===f&&"none"===h.css(a,"float")&&(!t.inlineBlockNeedsLayout||"inline"===e?m.display="inline-block":m.zoom=1);c.overflow&&(m.overflow="hidden",t.shrinkWrapBlocks()||g.always(function(){m.overflow=
c.overflow[0];m.overflowX=c.overflow[1];m.overflowY=c.overflow[2]}));for(d in b)if(f=b[d],Kd.exec(f)){delete b[d];j=j||"toggle"===f;if(f===(k?"hide":"show"))if("show"===f&&p&&void 0!==p[d])k=!0;else continue;s[d]=p&&p[d]||h.style(a,d)}if(!h.isEmptyObject(s))for(d in p?"hidden"in p&&(k=p.hidden):p=h._data(a,"fxshow",{}),j&&(p.hidden=!k),k?h(a).show():g.done(function(){h(a).hide()}),g.done(function(){var b;h._removeData(a,"fxshow");for(b in s)h.style(a,b,s[b])}),s)b=ec(k?p[d]:0,d,g),d in p||(p[d]=b.start,
k&&(b.end=b.start,b.start="width"===d||"height"===d?1:0))}],Da={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),f=Kc.exec(b),j=f&&f[3]||(h.cssNumber[a]?"":"px"),q=(h.cssNumber[a]||"px"!==j&&+d)&&Kc.exec(h.css(c.elem,a)),r=1,e=20;if(q&&q[3]!==j){j=j||q[3];f=f||[];q=+d||1;do r=r||".5",q/=r,h.style(c.elem,a,q+j);while(r!==(r=c.cur()/d)&&1!==r&&--e)}f&&(q=c.start=+q||+d||0,c.unit=j,c.end=f[1]?q+(f[1]+1)*f[2]:+f[2]);return c}]};h.Animation=h.extend(fc,{tweener:function(a,b){h.isFunction(a)?(b=
...
h.ajaxSettings),b):mb(h.ajaxSettings,a)},ajaxPrefilter:gc(Oc),ajaxTransport:gc(lb),ajax:function(a,b){function c(a,b,d,f){var l,s,w,B;B=b;if(2!==D){D=2;r&&clearTimeout(r);g=void 0;q=f||"";x.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(d){w=m;for(var C=x,t,u,W,E,H=w.contents,v=w.dataTypes;"*"===v[0];)v.shift(),void 0===u&&(u=w.mimeType||C.getResponseHeader("Content-Type"));if(u)for(E in H)if(H[E]&&H[E].test(u)){v.unshift(E);break}if(v[0]in d)W=v[0];else{for(E in d){if(!v[0]||w.converters[E+" "+v[0]]){W=
E;break}t||(t=E)}W=W||t}W?(W!==v[0]&&v.unshift(W),w=d[W]):w=void 0}a:{d=m;t=w;u=x;W=f;var y,I,z,C={},H=d.dataTypes.slice();if(H[1])for(I in d.converters)C[I.toLowerCase()]=d.converters[I];for(E=H.shift();E;)if(d.responseFields[E]&&(u[d.responseFields[E]]=t),!z&&(W&&d.dataFilter)&&(t=d.dataFilter(t,d.dataType)),z=E,E=H.shift())if("*"===E)E=z;else if("*"!==z&&z!==E){I=C[z+" "+E]||C["* "+E];if(!I)for(y in C)if(w=y.split(" "),w[1]===E&&(I=C[z+" "+w[0]]||C["* "+w[0]])){!0===I?I=C[y]:!0!==C[y]&&(E=w[0],
H.unshift(w[1]));break}if(!0!==I)if(I&&d["throws"])t=I(t);else try{t=I(t)}catch(F){w={state:"parsererror",error:I?F:"No conversion from "+z+" to "+E};break a}}w={state:"success",data:t}}if(f)m.ifModified&&((B=x.getResponseHeader("Last-Modified"))&&(h.lastModified[j]=B),(B=x.getResponseHeader("etag"))&&(h.etag[j]=B)),204===a||"HEAD"===m.type?B="nocontent":304===a?B="notmodified":(B=w.state,l=w.data,s=w.error,f=!s);else if(s=B,a||!B)B="error",0>a&&(a=0);x.status=a;x.statusText=(b||B)+"";f?G.resolveWith(k,
[l,B,x]):G.rejectWith(k,[x,B,s]);x.statusCode(P);P=void 0;e&&p.trigger(f?"ajaxSuccess":"ajaxError",[x,m,f?l:s]);A.fireWith(k,[x,B]);e&&(p.trigger("ajaxComplete",[x,m]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var d,f,j,q,r,e,g,s,m=h.ajaxSetup({},b),k=m.context||m,p=m.context&&(k.nodeType||k.jquery)?h(k):h.event,G=h.Deferred(),A=h.Callbacks("once memory"),P=m.statusCode||{},B={},t={},D=0,u="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===
D){if(!s)for(s={};b=Rd.exec(q);)s[b[1].toLowerCase()]=b[2];b=s[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===D?q:null},setRequestHeader:function(a,b){var c=a.toLowerCase();D||(a=t[c]=t[c]||a,B[a]=b);return this},overrideMimeType:function(a){D||(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>D)for(b in a)P[b]=[P[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||u;g&&g.abort(a);c(0,a);return this}};G.promise(x).complete=
A.add;x.success=x.done;x.error=x.fail;m.url=((a||m.url||ja)+"").replace(Qd,"").replace(Td,sa[1]+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=h.trim(m.dataType||"*").toLowerCase().match(Y)||[""];null==m.crossDomain&&(d=Nc.exec(m.url.toLowerCase()),m.crossDomain=!(!d||!(d[1]!==sa[1]||d[2]!==sa[2]||(d[3]||("http:"===d[1]?"80":"443"))!==(sa[3]||("http:"===sa[1]?"80":"443")))));m.data&&(m.processData&&"string"!==typeof m.data)&&(m.data=h.param(m.data,m.traditional));hc(Oc,m,b,x);if(2===
D)return x;(e=m.global)&&0===h.active++&&h.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!Sd.test(m.type);j=m.url;m.hasContent||(m.data&&(j=m.url+=(Qb.test(j)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Mc.test(j)?j.replace(Mc,"$1_="+Pb++):j+(Qb.test(j)?"&":"?")+"_="+Pb++));m.ifModified&&(h.lastModified[j]&&x.setRequestHeader("If-Modified-Since",h.lastModified[j]),h.etag[j]&&x.setRequestHeader("If-None-Match",h.etag[j]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&
x.setRequestHeader("Content-Type",m.contentType);x.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Pc+"; q=0.01":""):m.accepts["*"]);for(f in m.headers)x.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(k,x,m)||2===D))return x.abort();u="abort";for(f in{success:1,error:1,complete:1})x[f](m[f]);if(g=hc(lb,m,b,x)){x.readyState=1;e&&p.trigger("ajaxSend",[x,m]);m.async&&0<m.timeout&&(r=setTimeout(function(){x.abort("timeout")},
m.timeout));try{D=1,g.send(B,c)}catch(H){if(2>D)c(-1,H);else throw H;}}else c(-1,"No Transport");return x},getJSON:function(a,b,c){return h.get(a,b,c,"json")},getScript:function(a,b){return h.get(a,void 0,b,"script")}});h.each(["get","post"],function(a,b){h[b]=function(a,c,d,f){h.isFunction(c)&&(f=f||d,d=c,c=void 0);return h.ajax({url:a,type:b,dataType:f,data:c,success:d})}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.on(b,
...
(c["X-Requested-With"]="XMLHttpRequest");for(f in c)void 0!==c[f]&&j.setRequestHeader(f,c[f]+"");j.send(a.hasContent&&a.data||null);b=function(c,f){var r,e,g;if(b&&(f||4===j.readyState))if(delete ib[q],b=void 0,j.onreadystatechange=h.noop,f)4!==j.readyState&&j.abort();else{g={};r=j.status;"string"===typeof j.responseText&&(g.text=j.responseText);try{e=j.statusText}catch(m){e=""}!r&&a.isLocal&&!a.crossDomain?r=g.text?200:404:1223===r&&(r=204)}g&&d(r,e,g,j.getAllResponseHeaders())};a.async?4===j.readyState?
...
d&&!a._canSyncBinary(e);j&&e&&(b=b.replace(/pdb\.gz/,"pdb"),j=!1,d="text");e=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var r=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),g=a._isDirectCall(b),m=!r&&a.$supportsIECrossDomainScripting();if(!c||j)if(m||j||!r&&!g)return a._getRawDataFromServer("_",b,c,c,j,!0);b=b.replace(/file:\/\/\/\//,"file://");var k={dataType:d,async:!!c};e?(k.type="POST",
k.url=b.split("?POST?")[0],k.data=b.split("?POST?")[1]):(k.type="GET",k.url=b);c&&(k.success=function(){c(a._xhrReturn(k.xhr))},k.error=function(){c(xhr.statusText)});k.xhr=a.$ajax(k);if(!c)return a._xhrReturn(k.xhr)};a._xhrReturn=function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){for(var c in a.db._DirectDatabaseCalls)if(0<=c.indexOf(".")&&0<=b.indexOf(c))return!0;return!1};a._cleanFileData=
...
a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(c,"appletdiv","drop",function(d){d=d.originalEvent;d.stopPropagation();d.preventDefault();var e=d.dataTransfer.files[0];if(null==e)try{e=""+d.dataTransfer.getData("text"),(0==e.indexOf("file:/")||0==e.indexOf("http:/"))&&c._scriptLoad(e)}catch(g){}else{var j=new FileReader;j.onloadend=function(j){if(j.target.readyState==FileReader.DONE){var g="cache://DROP_"+e.name;j=a._toBytes(j.target.result);c._applet.cacheFileByName("cache://DROP_*",
!1);"JSV"==c._viewType||g.endsWith(".jdx")?a.Cache.put(g,j):c._applet.cachePut(g,j);(j=a._jsGetXY(c._canvas,d))&&(!c._applet.setStatusDragDropped||c._applet.setStatusDragDropped(0,j[0],j[1],g))&&c._applet.openFileAsyncSpecial(g,1)}};j.readAsArrayBuffer(e)}})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
function(a){window["j2s.lib"]&&(window["j2s.lib"].console=a)};a.binaryFolders=a._Loader.binaryFolders=[a._Loader.getJ2SLibBase()]}(Clazz))};___JmolDate="$Date: 2014-07-29 02:19:39 -0500 (Tue, 29 Jul 2014) $";___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";___JmolVersion="14.3.3_2014.07.29";
