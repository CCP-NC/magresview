...
setup(name='Magres format',
      ...
      scripts=['scripts/convertoldmagres.py', 'scripts/gui_convertmagres.py', 'scripts/magresjson.py', 'scripts/extract-jc-compare.py', 'scripts/compisc.py', 'scripts/magresmerge.py', 'scripts/extract-jc.py', 'scripts/extract-efg.py', 'scripts/absiscdev.py', 'scripts/nqr.py', 'scripts/magres-yaml.py', 'scripts/yaml-errors.py', 'scripts/copy-seed-tree.py', 'scripts/magres-ms-pcs.py'],
      )
